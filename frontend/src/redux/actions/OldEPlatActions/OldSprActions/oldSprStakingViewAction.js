import { SheepooriStakingContract, SheepooriTokenAddress, web3 } from "../../../../config/SheepooriStakingConfig";
    ...
    return async (dispatch) => {
        try {
            if (account !== "") {
                ...
                const oldSprRewardTokenPerstakingTokenApi = await SheepooriStakingContract.methods.rewardTokenPerstakingToken().call();
                ...
                // main
                const getMyTokenToBack = await axios.get(`https://alchemyapi.khans.io/alchemy/getNFTs?owner=${account}&contractAddress=${SheepooriTokenAddress}`);
                // test
                ...
                // main
                const stakingTokenIdImgBack = await axios.get(`https://alchemyapi.khans.io/alchemy/getNFTImages?contractAddress=${SheepooriTokenAddress}&tokenIds=${getStakedTokenIdsApi}`);
                ...
                let [
                    ...
                    getAmountStakedApi,
                    // tokenOwnerApi,
                    oldSprRewardTokenPerstakingTokenApi,
                    totalSupplyApi,
                ...
                dispatch({
                    ...
                    payload: {
                        ...
                        getOldSprAmountStaked: getAmountStaked,
                        // tokenOwner : tokenOwner,
                        oldSprRewardTokenPerstakingToken: oldSprRewardTokenPerstakingToken,
                        oldSprTotalSupply: totalSupply,
