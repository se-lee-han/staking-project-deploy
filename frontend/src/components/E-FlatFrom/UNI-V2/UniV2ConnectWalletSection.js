...
const UniV2ConnectWalletSection = () => {
    ...
    return (
        <div>
            {account === "" ? (
                <div className="connectUniV2MetaWalletSection">
                ...
                <div className="connectUniV2EtherWalletSection">
                    <a className="social-button button--social-login button--google" href="#">
                        <img
                            width="20px"
                            height="20px"
                ...
                <div className="connectUniV2OptiComWalletSection">
                    <a className="social-button button--social-login button--google" href="#">
                ...
                <div className="cantConnectUniV2WalletSection">
                    <p className="cantConnectUniV2Txt">Please switch to network</p>
                    <a className="social-button button--social-login button--google" href="#">
