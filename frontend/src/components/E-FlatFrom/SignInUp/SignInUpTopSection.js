...
import "./SignInUpTopSection.scss";

const SignInUpTopSection = () => {
            ...
            {loginState === true ? (
                ...
                <div className="airDropSignInUpContinaer">
                    <div className="airDropSignIn-BtnSection">
                        <a href="/hanep/signin" target="_parent">
                            Log in
                        </a>
                    </div>
                    <div className="airDropSignUp-BtnSection">
                        <a href="/hanep/signup">Sign up</a>
                    </div>
                </div>
            )}
        </div>
...
export default SignInUpTopSection;
