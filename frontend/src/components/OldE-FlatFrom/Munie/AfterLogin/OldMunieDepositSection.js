...
import { oldMunieSingleApproveAction } from "../../../../redux/actions/OldEPlatActions/OldMuineActions/oldMunieSingleApproveAction";
import { oldMunieStakeAction } from "../../../../redux/actions/OldEPlatActions/OldMuineActions/oldMunieStakeAction";
...
const OldMunieDepositSection = () => {
    ...
    const { getMyOldMunieTokenIds, getOldMunieSingleApproved, oldMuineDepositStakedAmount, successOldMunieApprove } = useSelector((state) => state.oldMunieStakingView);
...
export default OldMunieDepositSection;
