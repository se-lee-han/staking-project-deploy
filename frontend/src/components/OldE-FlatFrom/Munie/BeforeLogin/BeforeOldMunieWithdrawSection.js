...
const BeforeOldMunieWithdrawSection = () => {
    const dispatch = useDispatch();

    const [checkChainId, setCheckChainId] = useState('');
    const [myStakedOldMunieTokenId, setMyStakedOldMunieTokenId] = useState('');
    const { account } = useSelector((state) => state.account);
    const { oldMunieWithdrawStakedAmount, stakedOldMunieTokenId, oldMunieStakedTokenIds } = useSelector(
                                    ...
                                    {stakedOldMunieTokenId?.map((item, index) => {
                                        return (
                                            <div className="munieUnStakingSlider" key={index}>
                                                <div
                                                    className="munieUnStakingImgContainer"
                                                    id="munieUnStakingImgIdCardContainer"
                                                >
                                                    <div
...
export default BeforeOldMunieWithdrawSection;
