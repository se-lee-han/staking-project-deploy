...
import { oldSprStakingRewardAction } from "../../../../redux/actions/OldEPlatActions/OldSprActions/oldSprStakingRewardAction";
...
const OldSprRewardSection = () => {
    ...
    const sprClaim = () => {
        dispatch(oldSprStakingRewardAction.oldSprStakingRewardAct(account));
    };
    ...
    return (
        <div>
            ...
            <div className="rewardsClaimSprBtnSection">
                {oldSprResultValue + oldSprGetUnclaimedRewards <= 0 ? (
...
export default OldSprRewardSection;
